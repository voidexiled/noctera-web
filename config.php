...
$config = array(
	...
	'item_images_url' => 'images/animated-items/', // set to images/items if you host your own items in images folder
	...
	'enablePagseguroLocal' => true, // set true to enable donate and boxes page on localhost.
);
