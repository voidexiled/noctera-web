...
// Define un valor fijo de ETag
//$etag = '"12345abc"'; // Cambia este valor manualmente cuando quieras invalidar el caché

// Envía el ETag al cliente
//header("ETag: $etag");

$cacheDuration = 60 * 60 * 6 ; // 6 hrs

header('Cache-control: max-age=$cacheDuration');
header('Expires: ' . gmdate(DATE_RFC1123, time() + $cacheDuration));
header('Last-Modified: ' . gmdate('D, d M Y H:i:s', 3601) . ' GMT');
